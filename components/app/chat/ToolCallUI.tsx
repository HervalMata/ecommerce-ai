    ...
    return (
        <div className="space-y-2">
            ...
            <div className="flex gap-3">
                ...
                >
                    {isComplete ? (
                        <CheckCircle className="h-4 w-4 text-emerald-600 dark:text-emerald-400 shrink-8" />
                    ) : (
                        <Loader2 className="h-4 w-4 text-amber-600 dark:text-amber-400 animate-spin shrink-8" />
                    )}
                    <div className="flex flex-col">
                        ...
                        >
                            {isComplete ? `${displayName} completo` : `${displayName}...`}
                        </span>
                        {searchQuery && (
