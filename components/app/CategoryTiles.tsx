...
export function CategoryTiles(
    { categories, activeCategory }: CategoryTilesProps
) {
    return (
        <div className="relative">

            {/* Horizontal scrolling container - full width with edge padding */}
            <div className="flex gap-4 overflow-x-auto py-4 pl-8 pr-4 sm:pl-12 sm:pr-6 
                            lg:pl-10 lg:pr-8 scrollbar-hide">
                ...
                >
                    <div className="relative h-32 w-56 sm:h-56 sm:w-80">
                        ...
                        {/* Gradient background */}
                        <div className="absolute inset-0 bg-gradient-to-r from-zinc-800 to-zinc-800 dark:from-zinc-700 dark:to-zinc-800" />
                    ...
                    return (
                        ...
                        >
                            <div className="relative h-32 w-56 sm:h-56 sm:w-80">
                                ...
                                {/* Bark overlay for text readability */}
                                <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent transition-opacity duration-300 group-hover:from-black/80"></div>
